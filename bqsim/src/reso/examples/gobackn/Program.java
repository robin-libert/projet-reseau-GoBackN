...
/*Cette classe est la classe qui permet de paramétrer en particulier les différents parametres a transmettre a la classe AppSender: le nombre de messages avec une certaine probabilite
*de perte.
*/
...
public class Program{
	...
	Network network= new Network(scheduler);
    	try {
    		...
    		host1.addApplication(new AppSender(host1, IP_ADDR2,10000,1));//envoi de x messages avec proba y
